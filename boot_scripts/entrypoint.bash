...
mv "${NOTEBOOK_BASE_DIR}/stomac.obj" "${NOTEBOOK_BASE_DIR}/workspace/stomac.obj" || true
# mv "${NOTEBOOK_BASE_DIR}/scaffold.vtk" "${NOTEBOOK_BASE_DIR}/workspace/scaffold.vtk" || true
# mv "${NOTEBOOK_BASE_DIR}/scaffold.stl" "${NOTEBOOK_BASE_DIR}/workspace/scaffold.stl" || true
# mv "${NOTEBOOK_BASE_DIR}/scaffold.obj" "${NOTEBOOK_BASE_DIR}/workspace/scaffold.obj" || true
