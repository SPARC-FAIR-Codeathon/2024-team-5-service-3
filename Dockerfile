...
COPY --chown=$NB_UID:$NB_GID stomac.obj ${NOTEBOOK_BASE_DIR}/stomac.obj
# COPY --chown=$NB_UID:$NB_GID scaffold.vtk ${NOTEBOOK_BASE_DIR}/scaffold.vtk
# COPY --chown=$NB_UID:$NB_GID scaffold.stl ${NOTEBOOK_BASE_DIR}/scaffold.stl
# COPY --chown=$NB_UID:$NB_GID scaffold.obj ${NOTEBOOK_BASE_DIR}/scaffold.obj
